...
type DeepProbe struct {
	...
	Name        string          // human-readable label shown in the probe selector: "SMTP [EHLO]", "Redis [PING]", …
	ServiceName string          // friendly service category for the Services tab: "Email Server", "Redis Server", …
